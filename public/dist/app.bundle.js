...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _domMethods__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./domMethods */ \"./assets/js/domMethods.js\");\n/* harmony import */ var _API__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./API */ \"./assets/js/API.js\");\n/* harmony import */ var _indexedDb__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./indexedDb */ \"./assets/js/indexedDb.js\");\n// DEPENDENCIES\n\n\n\nvar transactions = [];\nvar myChart;\n\nfunction renderTransactions(transactions, myChart) {\n  Object(_domMethods__WEBPACK_IMPORTED_MODULE_0__[\"populateTotal\"])(transactions);\n  Object(_domMethods__WEBPACK_IMPORTED_MODULE_0__[\"populateTable\"])(transactions);\n  Object(_domMethods__WEBPACK_IMPORTED_MODULE_0__[\"populateChart\"])(transactions, myChart);\n}\n\nfetch(\"/api/transaction\").then(function (response) {\n  return response.json();\n}).then(function (data) {\n  // save db data on global variable\n  transactions = data;\n  renderTransactions(transactions, myChart);\n}); // check for indexedDb objects to render onto page\n\nwindow.addEventListener(\"online\", _indexedDb__WEBPACK_IMPORTED_MODULE_2__[\"checkDatabase\"]);\n\ndocument.querySelector(\"#add-btn\").onclick = function () {\n  Object(_API__WEBPACK_IMPORTED_MODULE_1__[\"sendTransaction\"])(true, transactions, myChart);\n};\n\ndocument.querySelector(\"#sub-btn\").onclick = function () {\n  Object(_API__WEBPACK_IMPORTED_MODULE_1__[\"sendTransaction\"])(false, transactions, myChart);\n};\n\n//# sourceURL=webpack:///./assets/js/index.js?");
